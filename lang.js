(function () {
  ...
  var T = {
    en: {
      ...
      // ── GIF Maker ───────────────────────────────────────────
      'g.step1':        '1) Upload Images',
      'g.step2':        '2) Frames',
      'g.dropStrong':   'Drag &amp; drop images here',
      'g.dropSub':      'or click to select — JPG, PNG, WebP, GIF',
      'g.dropSubMobile':'Tap to select images',
      'g.reverse':      '↕ Reverse',
      'g.clearAll':     'Clear All',
      'g.previewEmpty': 'Preview will appear here after generating.',
      'g.downloadMp4':  '&#11015; Download Video',
      'g.wmTitle':      '5) Logo Watermark',
      'g.wmEnable':     'Add logo watermark',
      'g.txtTitle':     '6) Text Overlay',
      'g.txtEnable':    'Add text overlay',
      'g.txtContent':   'Text',
      'g.txtPosition':  'Position',
      'g.txtSize':      'Text size (% of height)',
      'g.txtColor':     'Text colour',
      'g.txtBg':        'Background',
      'g.txtPerFrameHint': 'Use the T button on each frame above to show/hide text on that frame.',
      'g.addTxt':       '+ Add text',
      'g.settings':     '3) GIF Settings',
      'g.delay':        'Default frame delay (seconds)',
      'g.delayHint':    'This applies to all frames. You can also override per-frame in the list above.',
      'g.loop':         'Loop',
      'g.outputSize':   'Output size',
      'g.matchFirst':   'Match first frame',
      'g.custom':       'Custom dimensions…',
      'g.widthPx':      'Width (px)',
      'g.heightPx':     'Height (px)',
      'g.optimize':     'Optimize file size',
      'g.optimizeHint': 'Scales images down and reduces colour palette. Turn off for original resolution and best quality.',
      'g.quality':      'Colour quality',
      'g.qualityHint':  'Controls colour precision. 10 = best quality, 1 = fastest encode.',
      'g.dithering':    'Dithering',
      'g.ditheringHint':'Dithering improves colour gradients at the cost of speed.',
      'g.border':       '4) Border / Padding',
      'g.addBorder':    'Add border / padding',
      'g.borderWidth':  'Border width',
      'g.borderSides':  'Border sides',
      'g.borderColor':  'Border colour',
      'g.objectFit':    'Object fit',
      'g.bgColor':      'Background colour',
      'g.export':       '7) Preview &amp; Export',
      'g.generate':     '&#9654; Generate GIF',
      'g.download':     '&#11015; Download GIF',
    },
    bg: {
      // Navigation
      ...
      // ── GIF Мейкър ─────────────────────────────────────────
      'g.step1':        '1) Качи изображения',
      'g.step2':        '2) Кадри',
      'g.dropStrong':   'Провлачи изображения тук',
      'g.dropSub':      'или клик за избор — JPG, PNG, WebP, GIF',
      'g.dropSubMobile':'Натисни за избор на изображения',
      'g.reverse':      '↕ Обърни',
      'g.clearAll':     'Изчисти всичко',
      'g.previewEmpty': 'Прегледът ще се появи след генерирането.',
      'g.downloadMp4':  '&#11015; Изтегли видео',
      'g.wmTitle':      '5) Лого воден знак',
      'g.wmEnable':     'Добави лого воден знак',
      'g.txtTitle':     '6) Текстово наслагване',
      'g.txtEnable':    'Добави текстово наслагване',
      'g.txtContent':   'Текст',
      'g.txtPosition':  'Позиция',
      'g.txtSize':      'Размер на текста (% от височина)',
      'g.txtColor':     'Цвят на текста',
      'g.txtBg':        'Фон',
      'g.txtPerFrameHint': 'Използвай бутона T на всеки кадър горе, за да покажеш/скриеш текста на него.',
      'g.addTxt':       '+ Добави текст',
      'g.settings':     '3) Настройки за GIF',
      'g.delay':        'Закъснение на кадри (секунди)',
      'g.delayHint':    'Прилага се към всички кадри. Можеш да го промениш за всеки кадър поотделно.',
      'g.loop':         'Повторение',
      'g.outputSize':   'Размер на изхода',
      'g.matchFirst':   'Спрямо първия кадър',
      'g.custom':       'Персонален размер…',
      'g.widthPx':      'Ширина (px)',
      'g.heightPx':     'Височина (px)',
      'g.optimize':     'Оптимизирай размера',
      'g.optimizeHint': 'Намалява изображенията и цветовата палитра. Изключи за оригинална резолюция и качество.',
      'g.quality':      'Цветово качество',
      'g.qualityHint':  'Контролира цветовата точност. 10 = най-добро качество, 1 = най-бързо.',
      'g.dithering':    'Дитъринг',
      'g.ditheringHint':'Дитърингът подобрява цветовите преходи, но е по-бавен.',
      'g.border':       '4) Рамка / Отстъп',
      'g.addBorder':    'Добави рамка / отстъп',
      'g.borderWidth':  'Ширина на рамката',
      'g.borderSides':  'Страни на рамката',
      'g.borderColor':  'Цвят на рамката',
      'g.objectFit':    'Вписване на обект',
      'g.bgColor':      'Цвят на фона',
      'g.export':       '7) Преглед и Експорт',
      'g.generate':     '&#9654; Генерирай GIF',
      'g.download':     '&#11015; Изтегли GIF',
    }
  };
